...
function geschenkly_enqueue_assets() {
    if (is_product()) {
        ...
        $css_ver  = file_exists($base . 'assets/css/style-v6.css') ? filemtime($base . 'assets/css/style-v6.css') : null;
        ...
        wp_enqueue_style('geschenkly-style', $url . 'assets/css/style-v6.css', array(), $css_ver);
    ...
    <div class="product-ratings" style="margin-top: 20px; display: flex; justify-content: center;">
        ...
        <?php endif; ?>
            ...
            <div class="gift-summary">
                ...
                <div class="analytics-item summary-item-full">
