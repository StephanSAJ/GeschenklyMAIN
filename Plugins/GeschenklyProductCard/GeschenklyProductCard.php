...
function geschenkly_enqueue_assets() {
    if (is_product()) {
        ...
        $css_ver  = file_exists($base . 'assets/css/style-v5.css') ? filemtime($base . 'assets/css/style-v5.css') : null;
        ...
        wp_enqueue_style('geschenkly-style', $url . 'assets/css/style-v5.css', array(), $css_ver);
