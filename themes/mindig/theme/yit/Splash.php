    ...
    public function add_splash_style(){
        ...
        <style>
            ...
            #loginform .forgetmenot label {
              font-family: '<?php echo isset($remember_me['family']) ? $remember_me['family'] : "default-family"; ?>', serif;
              font-size: <?php echo isset($remember_me['size']) ? $remember_me['size'] : "default-size"; ?><?php echo isset($label['unit']) ? $label['unit'] : "px"; ?>;
              font-weight: <?php echo isset($remember_me['font-weight']) ? $remember_me['font-weight'] : "normal"; ?>;
              text-transform: <?php echo isset($remember_me['transform']) ? $remember_me['transform'] : "none"; ?>;
              color: <?php echo isset($remember_me['color']) ? $remember_me['color'] : "#000"; ?>;
            }
