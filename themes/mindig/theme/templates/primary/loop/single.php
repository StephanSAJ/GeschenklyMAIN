...
// Fix for accessing array offset on null value
$author_icon_options     = yit_get_option( 'blog-single-author-icon' ) ?: array('select' => 'none', 'icon' => '', 'custom' => '');
...
$categories_icon_options = yit_get_option( 'blog-single-categories-icon' ) ?: array('select' => 'none', 'icon' => '', 'custom' => '');
...
$tags_icon_options       = yit_get_option( 'blog-single-tags-icon' ) ?: array('select' => 'none', 'icon' => '', 'custom' => '');
...
$comments_icon_options   = yit_get_option( 'blog-single-comments-icon' ) ?: array('select' => 'none', 'icon' => '', 'custom' => '');
...
$share_icon_options      = yit_get_option( 'blog-single-share-icon' ) ?: array('select' => 'none', 'icon' => '', 'custom' => '');
$share_icon_type         = isset($share_icon_options['select']) ? $share_icon_options['select'] : 'none';
