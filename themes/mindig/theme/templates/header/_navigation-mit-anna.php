...
<?php if ( has_nav_menu( 'mobile-nav' ) ) : ?>
  ...
  /**  <button class="anna-support"; onclick="location.href = 'https://geschenkly.de/anna-deine-geschenk-beraterin/'">
     *   <img src="https://geschenkly.de/wp-content/uploads/2017/06/gift.png" alt="Anna Geschenkberaterin"/> Anna Geschenkberaterin
  *  </button>
 */
    <!-- END MOBILE MENU -->
<?php endif; ?>
